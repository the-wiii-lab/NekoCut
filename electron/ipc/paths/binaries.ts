...
export function getNativeCaptureHelperBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "nekocut-screencapturekit-helper");
}
...
export function getSystemCursorHelperBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "nekocut-system-cursors");
}
...
export function getNativeCursorMonitorBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "nekocut-native-cursor-monitor");
}
...
export function getNativeWindowListBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "nekocut-window-list");
}
...
export async function ensureNativeCaptureHelperBinary(): Promise<string> {
	...
	return ensureSwiftHelperBinary(
		...
		"nekocut-screencapturekit-helper",
	);
}
