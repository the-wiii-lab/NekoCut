...
export type ZoomTransitionEasing = "nekocut" | "glide" | "smooth" | "snappy" | "linear";
...
export const DEFAULT_ZOOM_IN_EASING: ZoomTransitionEasing = "nekocut";
export const DEFAULT_ZOOM_OUT_EASING: ZoomTransitionEasing = "nekocut";
